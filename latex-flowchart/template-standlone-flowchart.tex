...
\begin{figure}[H]
    \begin{center}
        \begin{tikzpicture}[node distance=1.5cm]
            ...
            \node (lppInit) [subroutine, below of=send, xshift=2cm] {Init LPP buffer};
            ...
            \node (addData0) [subroutine, right of=data0, xshift=2.5cm] {Add data0 to LPP packet};
            ...
            \node (addData1) [subroutine, right of=data1, xshift=2.5cm] {Add data1 to LPP packet};
            ...
            \node (copyData) [subroutine, below of=disableInt] {Copy data (\textbf{*1})};
            ...
            \node (parseData) [subroutine, right of=bufferFilled, xshift=2.7cm] {Parse data (\textbf{*3})};
